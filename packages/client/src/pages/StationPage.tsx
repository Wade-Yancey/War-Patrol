            ...
            {controlsTab === 'weapons' && (canTorpedo || canDepthCharges) && (
              <>
                ...
                <p className="muted controls-ambient-note">
                  Bridge audio: nearby depth-charge detonations play on this screen when within
                  ~0.45 nm of own ship (any vessel — not only the dropper). Hydrophone hears the
                  same sample at longer range when submerged.
                </p>
              </>
            )}
